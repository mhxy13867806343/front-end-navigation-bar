export const menuItemsList = [
  ...
  },
  {
    ...
    "tools": [
      ...
      { "id": "mcp-server-brave-search", "name": "Brave Search", "desc": "官方参考实现通过 Brave Search API 提供网页与本地搜索。", "icon": "🦁", "link": "https://github.com/modelcontextprotocol/servers-archived/tree/main/src/brave-search", "platform": "Cloud", "price": "免费/付费" },
      ...
      { "id": "mcp-server-postgresql", "name": "PostgreSQL", "desc": "官方参考服务器以只读方式探索 PostgreSQL 数据库结构与内容。", "icon": "🐘", "link": "https://github.com/modelcontextprotocol/servers-archived/tree/main/src/postgres", "platform": "MCP", "price": "免费" },
