...
const createThemeItem = (i: number): AuthThemeItem => {
  ...
  return {
    ...
    features: ['100w 级虚拟索引', '0ms 按需生成', '防伪校验与安全拦截', '社交账号一键极速登录']
  }
}
...
// 分页与跳转 State (按每页 50 条分页，共 20,000 页)
    ...
    <div class="filter-control-bar">
      ...
      <div style="display: flex; gap: 8px; align-items: center;">
        ...
        <div style="display: flex; gap: 4px; align-items: center; background: rgba(30,41,59,0.8); padding: 4px 8px; border-radius: 10px; border: 1px solid rgba(255,255,255,0.1);">
          ...
          <input v-model.number="jumpPageInput" type="number" placeholder="1-20000" style="width: 75px; padding: 4px 8px; border-radius: 6px; border: 1px solid #334155; background: #0f172a; color: #fff; font-size: 0.8rem;" @keyup.enter="jumpToPageNumber" />
