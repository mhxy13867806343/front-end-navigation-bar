...
const PROXY_MAP: Record<string, string> = {
  ...
  '/api-invidious': 'https://inv.zoomerville.com',
  '/api-freetogame': 'https://www.freetogame.com',
  '/api-gamerpower': 'https://www.gamerpower.com',
  '/api-cheapshark': 'https://www.cheapshark.com',
  '/api-taobao-suggest': 'https://suggest.taobao.com',
  '/api-kuaidi100': 'https://www.kuaidi100.com',
  '/api-google-ajax': 'https://ajax.googleapis.com',
  '/api-baidu-baike': 'https://baike.baidu.com',
  '/api-baidu-map': 'https://api.map.baidu.com',
  '/api-sina-weather': 'https://php.weather.sina.com.cn',
  ...
  '/api-github-cn-api': 'https://api.github-cn.com'
}
