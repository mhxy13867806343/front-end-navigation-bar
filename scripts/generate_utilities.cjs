...
fs.writeFileSync(path.join(targetDir, 'string.js'), stringCode);
fs.writeFileSync(path.join(targetDir, 'array.js'), arrayCode);
fs.writeFileSync(path.join(targetDir, 'object.js'), objectCode);
fs.writeFileSync(path.join(targetDir, 'math.js'), mathCode);
fs.writeFileSync(path.join(targetDir, 'color.js'), colorCode);
fs.writeFileSync(path.join(targetDir, 'browser.js'), browserCode);
fs.writeFileSync(path.join(targetDir, 'validator.js'), validatorCode);
...
console.log('Unified registry index.js generated successfully!');
