...
fs.writeFileSync(path.join(targetDir, 'string.js'), stringsCode);
fs.writeFileSync(path.join(targetDir, 'array.js'), arraysCode);
fs.writeFileSync(path.join(targetDir, 'object.js'), objectsCode);
