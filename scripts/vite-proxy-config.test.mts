...
test('Vite proxy config is generated from shared defaults', async () => {
  ...
  const cnblogsIngProxy: ProxyOptions = getProxyEntry(serverProxy, '/api-cnblogs-ing')
  const cnblogsOpenApiProxy: ProxyOptions = getProxyEntry(serverProxy, '/api-cnblogs-openapi')
  ...
  assert.equal(cnblogsIngProxy.target, 'https://ing.cnblogs.com')
  assert.equal(cnblogsIngProxy.headers?.Referer, 'https://ing.cnblogs.com/')
  assert.equal(cnblogsIngProxy.rewrite?.('/api-cnblogs-ing/ajax/ing/GetIngList'), '/ajax/ing/GetIngList')
  assert.equal(cnblogsOpenApiProxy.target, 'https://api.cnblogs.com')
  assert.equal(cnblogsOpenApiProxy.rewrite?.('/api-cnblogs-openapi/api/statuses/@all'), '/api/statuses/@all')
